export default function Home() {
  return (
    <main className="bg-white text-slate-900">
      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center flex-col text-center p-8 bg-gradient-to-br from-blue-100 to-cyan-100" data-aos="fade-up">
      ...
      <section className="py-20 px-8 bg-white" data-aos="fade-up">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="p-6 border border-slate-200 rounded-xl shadow-sm hover:shadow-lg transition" data-aos="fade-up" data-aos-delay={i * 100}>
...
{/* Case Studies */}
<section className="py-20 px-8 bg-slate-50" data-aos="fade-up">
  <h2 className="text-3xl font-bold text-center mb-12">Featured Work</h2>
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition" data-aos="fade-up" data-aos-delay={i * 100}>
...
{/* Team Section */}
<section className="py-20 px-8 bg-slate-100 text-center" data-aos="fade-up">
  ...
  <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto text-left">
    {[
      ...
      <div key={i} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition" data-aos="fade-up" data-aos-delay={i * 100}>
